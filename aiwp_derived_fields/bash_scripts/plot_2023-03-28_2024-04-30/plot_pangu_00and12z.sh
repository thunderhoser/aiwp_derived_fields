...
while [ $i -lt ${#INIT_TIME_STRINGS[@]} ]; do
    ...
    log_file_name="plot_derived_fields_pangu_${INIT_TIME_STRINGS[$i]}_${current_time_string}.out"
    ...
    --output_dir_name="${INPUT_DIR_NAME}/plots/PANG_v100/${INIT_TIME_STRINGS[$i]}"
